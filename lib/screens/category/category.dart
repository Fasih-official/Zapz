...
class Category extends StatefulWidget {
  ...
  Category({Key key, @required this.homePageCategories}) : super(key: key);
...
//  CategoryPageModel _categoryPage;
  ...
  List<CategoryModel> categoryListing;
  ...
  Future<void> _loadData() async {
    categoryListing = await Api.getCategoryListing();
    setState(() {
      _controller.refreshCompleted();
      _category = categoryListing;
    });
  }
